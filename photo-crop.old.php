...
// Include the JS file
$js_files = array("js/cropper.min.js", "js/bootbox.all.min.js", "js/clipboard.min.js", "js/jssocials.min.js", "js/jquery.toast.min.js", "js/pages/photo_crop.js");
$css_files = array("css/jssocials.css", "css/cropper.min.css", "css/jquery.toast.min.css", "css/jssocials-theme-flat.css");
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            <div class="text-center upload-container">
                                ...
                                <h1 class="photo_title text-gray-900">Edit Photo</h1>
                                <?php
								...
								<div class="row">
									<div class="col-md-3">
										<div class="bg-grey">Actions</div>
							            
							            <button class="btn btn-block btn-sm btn-info btn-flip"><i class="fas fa-arrows-alt-h"></i> Flip Horizontally</button>
							     
							            <button class="btn btn-block btn-sm btn-info btn-rotate"><i class="fas fa-redo"></i> Rotate</button>
							    
							            <button class="btn btn-block btn-sm btn-info btn-resize"><i class="fas fa-expand"></i> Resize</button>
							    
							            <button class="btn btn-block btn-sm btn-info btn-act-crop"><i class="fas fa-crop"></i> Crop</button>
									...
									<div class="col-md-9">
		                                ...
		                                <div class="p_photo_container">
			                                <img id="crop-upload-img" data-scale="1" src="<?php echo URL; ?>/<?php echo $photo["url"]; ?>?v=<?php echo mt_rand(0,99999); ?>" />
		                                </div>
		                                <?php
			                            } else {
				                        ?>
		                                <div class="p_photo_container p_photo_file_container">
			                                <img src="img/file_2.png" />
		                                </div>
				                        <?php
			                            }  
			                            ?>
							    ...
							    <div class="row">
							        ...
							        <div class="col-md-3">
							            <div class="input-group input-group-sm">
							                ...
							                <input type="number" class="form-control data-width" id="data-width" placeholder="width">
							        ...
							        <div class="col-md-3">
							            <div class="input-group input-group-sm">
							                ...
							                <input type="number" class="form-control data-height" id="data-height" placeholder="height">
							                <span class="input-group-append">
												<span class="input-group-text">px</span>
							                </span>
							            </div>
							        ...
							        <div class="col-md-3">
							            <button class="btn btn-block btn-sm btn-info btn-apply-ratio">Apply</button>
							        </div>
							    </div>
	                            ...
	                            <div class="row">
							        ...
							        <div class="col-md-3">
							            <button class="btn btn-block btn-sm btn-info btn-resize"><i class="fas fa-crop"></i> Resize</button>
							        </div>
							    </div>
	                            <br />
	                            -->
	                            <div class="form-control save_as_new_container">
	                            	<input type="checkbox" class="save_as_new" /> Save as new photo
	                            </div>
	                            <a href="" class="btn btn-primary btn-crop"><i class="fas fa-check"></i> Save</a><br>
