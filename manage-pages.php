					...
					<table class="table table-bordered"
						...
						<tr class="page-line" data-id="<?php echo $page["id"]; ?>">
							...
							<td>
								<div class="row">
									<div class="col-md-4">
										<a class="btn btn-dark  btn-sm btn-block" href="<?php echo URL; ?>/page.php?id=<?php echo $page["id"]; ?>"><i class="fas fa-eye"></i></a>
									</div>
									<div class="col-md-4">
										<a href="edit-page.php?id=<?php echo $page["id"]; ?>" class="btn btn-primary btn-admin-edit btn-sm btn-block"><i class="fas fa-pencil-alt"></i></a>
									</div>
									<div class="col-md-4">
