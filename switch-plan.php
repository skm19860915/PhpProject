...
// Include the JS file
$js_files = array("js/pages/switch_plan.js");
$css_files = array();
								        ...
								        <div class="card mb-5 mb-lg-0">
								            <div class="card-body">
								                ...
								                <div class="monthly_prices">
													...
													<div class="or_per_year">
								                	or <h6 class="card-price text-center"><strike>$<?php echo number_format($silver_plan["yearly_price"], 2); ?></strike> $<?php echo number_format($silver_plan["yearly_price"]/2, 2); ?><span class="period">/year</span></h6>
													</div>
								                </div>
								                <div class="yearly_prices">
													...
													<div class="or_per_year"><strike>$<?php echo number_format($silver_plan["yearly_price"], 2); ?></strike> $<?php echo number_format($silver_plan["yearly_price"]/2, 2); ?><span class="period">/year</span></div>
						
								                </div>
								                <hr>
								                <ul class="fa-ul">
									                <li><span class="fa-li"><i class="fas fa-check"></i></span><b><?php echo $silver_plan["images"]; ?></b> Images - <b><?php echo $silver_plan["diskspace"]/1000; ?>GB</b> storage</li>
								                ...
								                <div class="monthly_prices">
								                	<a href="redirect-pay.php?plan=<?php echo STRIPE_PLAN_1; ?>&plan_id=1" class="btn btn-block btn-primary text-uppercase">Subscribe</a>
								                </div>
								                <div class="yearly_prices">
								                	<a href="redirect-pay.php?plan=<?php echo STRIPE_PLAN_4; ?>&plan_id=1" class="btn btn-block btn-primary text-uppercase">Subscribe</a>
								                </div>
								            </div>
								        </div>
								    </div>
								        ...
								        <div class="card mb-5 mb-lg-0">
								            <div class="card-body">
								                ...
								                <div class="monthly_prices">
													...
													<div class="or_per_year">
													or <h6 class="card-price text-center"><strike>$<?php echo number_format($gold_plan["yearly_price"], 2); ?></strike> $<?php echo number_format($gold_plan["yearly_price"]/2, 2); ?><span class="period">/year</span></h6>
													</div>
												...
												<div class="yearly_prices">
													...
													<div class="or_per_year"><strike>$<?php echo number_format($silver_plan["yearly_price"], 2); ?></strike> $<?php echo number_format($gold_plan["yearly_price"]/2, 2); ?><span class="period">/year</span></div>
								               	</div>
											   	<hr>
								                <ul class="fa-ul">
									                <li><span class="fa-li"><i class="fas fa-check"></i></span><b><?php echo $gold_plan["images"]; ?></b> Images<br><b><?php echo $gold_plan["diskspace"]/1000; ?>GB</b> storage</li>
								                ...
								                <div class="monthly_prices">
								                	<a href="redirect-pay.php?plan=<?php echo STRIPE_PLAN_2; ?>&plan_id=2" class="btn btn-block btn-primary text-uppercase">Subscribe</a>
								                </div>
								                <div class="yearly_prices">
								                	<a href="redirect-pay.php?plan=<?php echo STRIPE_PLAN_5; ?>&plan_id=2" class="btn btn-block btn-primary text-uppercase">Subscribe</a>
								                </div>
								            </div>
								        </div>
								    </div>
								        ...
								        <div class="card mb-5 mb-lg-0">
								            <div class="card-body">
								                ...
								                <div class="yearly_prices">
													...
													<div class="or_per_year"><strike>$<?php echo number_format($platinum_plan["yearly_price"], 2); ?></strike> $<?php echo number_format($platinum_plan["yearly_price"]/2, 2); ?><span class="period">/year</span></div>
									            </div>
								                <hr>
								                <ul class="fa-ul">
								                ...
								                <div class="monthly_prices">
								                	<a href="redirect-pay.php?plan=<?php echo STRIPE_PLAN_3; ?>&plan_id=3" class="btn btn-block btn-primary text-uppercase">Subscribe</a>
								                </div>
								                <div class="yearly_prices">
								                	<a href="redirect-pay.php?plan=<?php echo STRIPE_PLAN_6; ?>&plan_id=3" class="btn btn-block btn-primary text-uppercase">Subscribe</a>
								                </div>
								            </div>
								        </div>
								    </div>
