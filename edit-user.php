			...
			<div class="card-body">
				...
				<div class="row">               
                    ...
                    <div class="col-md-6">
						...
						<?php echo $user_diskspace; ?> / <?php echo $max_diskspace; ?> MB
                    </div>
                </div>
                ...
                <div class="text-center">
	            	<a class="btn btn-primary" href="view-user-files.php?id=<?php echo $user_id; ?>"><i class="fas fa-eye"></i> View User Files (<?php echo $nb_files_user; ?>)</a>    
                </div>
