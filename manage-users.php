						...
						<tr class="user-line" data-id="<?php echo $user["id"]; ?>">
							...
							<td>
								<div class="row d-flex align-items-center">
									<div class="col-md-4">
										<a data-id="<?php echo $user["id"]; ?>" data-username="<?php echo $user["username"]; ?>" data-email="<?php echo $user["email"]; ?>" data-rank="<?php echo $user["rank"]; ?>" href="view-user-files.php?id=<?php echo $user["id"]; ?>" class="btn btn-primary btn-sm btn-block"><i class="fas fa-file"></i> View Files</a>
									</div>
									<div class="col-md-4">
										<a data-id="<?php echo $user["id"]; ?>" data-username="<?php echo $user["username"]; ?>" data-email="<?php echo $user["email"]; ?>" data-rank="<?php echo $user["rank"]; ?>" href="edit-user.php?id=<?php echo $user["id"]; ?>" class="btn btn-primary btn-sm btn-block"><i class="fas fa-pencil-alt"></i> Infos & Edit</a>
									</div>
									<div class="col-md-4">
